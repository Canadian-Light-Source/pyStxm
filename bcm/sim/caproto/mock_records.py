...
class RecordMockingIOC(PVGroup):
    ...
    B = pvproperty(value=2.0, mock_record="ao", precision=3)
    MTR = pvproperty(value=2.0, mock_record="motor", precision=3)
    ...
    D = pvproperty(value=2.0, mock_record="ao", precision=3, field_spec=B.field_spec)
