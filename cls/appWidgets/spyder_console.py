...
class ShellDock(QtWidgets.QDockWidget):
    ...
    def __init__(
        ...
        self.pythonshell = internalshell.InternalShell(
            self, namespace=globals(), commands=[], multithreaded=False
        )
...
class ShellWidget(QtWidgets.QWidget):
    ...
    def __init__(
        self, parent=None, namespace=globals(), commands=[], multithreaded=False
    ):
