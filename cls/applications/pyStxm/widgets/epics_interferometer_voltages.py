...
path_sep = ";"
epicsPath = r"C:\controls\epics\R7\base\bin\windows-x64-mingw;C:\controls\epics\R7\base\lib\windows-x64-mingw;C:\controls\git\pyStxm"
...
def callback(task, event_type, samples, callback_data):
    print()
    data = task.read(
        samples, samples_per_channel=samples, fill_mode="group_by_scan_number"
    )
...
class InterferometerSignalWindow(QtWidgets.QWidget):
    ...
    def __init__(self, axis1=None, axis2=None, parent=None):
