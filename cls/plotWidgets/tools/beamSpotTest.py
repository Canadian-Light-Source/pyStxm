...
from plotpy.items.annotation import PolygonShape, Axes, EllipseShape
from plotpy.tools import LoadItemsTool, SaveItemsTool, ImageMaskTool
from cls.plotWidgets.tools.beamspotShape import BeamSpotShape
...
def make_beam_spot(cx, cy, scale=1.0):
    ...
    c1 = set_beamspot_shape_params(
        EllipseShape(cx, cy, cx - circ_diam, cy + circ_diam),
        "beamspot_circle",
        clr="yellow",
    )
