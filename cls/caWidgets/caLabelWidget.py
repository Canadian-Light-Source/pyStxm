...
class CALabelException(Exception):
    pass
...
def format_text(title, var, title_color="black", var_color="black", alarm=None):
    ...
    s = (
        '<a style="background-color: transparent; color: %s"><b>%s</b>\t <a border-width: 50px; style="background-color: %s; color: %s"><b>%s</b> </a>'
...
class ca_strLabel(BaseLabel):
    def __init__(self, pv, hdrText="", title_color=None, var_clr=None):
        super(ca_strLabel, self).__init__(
            pv, hdrText=hdrText, sig_change_kw="char_value"
        )
        self.prefix = pv.get_name()
        self.hdrText = hdrText
        self.title_color = title_color
...
class ca_aiLabelWidget(BaseLabel):
    def __init__(
        ...
        caLabelWidget
        """
        super(ca_aiLabelWidget, self).__init__(
            pv,
            hdrText=hdrText,
            sig_change_kw="value",
            egu=egu,
...
class ca_mbbiLabelWidget(BaseLabel):
    def __init__(
        self, pv, labelWidget=None, hdrText=None, title_color=None, var_clr=None
    ):
        super(ca_mbbiLabelWidget, self).__init__(
            pv, hdrText=hdrText, sig_change_kw="value"
        )
        self.setMinimumWidth(150)
        self.hdrText = hdrText
        self.prefix = pv.get_name()
        ...
        for fname in self.fields:
            ...
            try:
                ...
                # pass
                raise CALabelException(
                    f"Failed to create a BaseDevice for {self.prefix}"
                )
    ...
    def set_text(self, val):
        ...
        try:
            ...
            # pass
            raise CALabelException(f"Failed to setText for {self.prefix}")
...
class ca_biLabelWidget(BaseLabel):
    ...
    def __init__(
        ...
        # QtWidgets.QLabel.__init__(self)
        super(ca_biLabelWidget, self).__init__(
            pv, hdrText=hdrText, sig_change_kw="value"
        )
...
class test(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.evFbkLbl = ca_aiLabelWidget(
            MAIN_OBJ.device("DNM_ENERGY_RBV"),
            hdrText="Energy",
            egu="eV",
            title_color=title_color,
            var_clr=fbk_color,
        ...
        self.aiFbkLbl = ca_aiLabelWidget(
        ...
        self.temp_aiFbkLbl = ca_aiLabelWidget(
            temp_fbk_sig,
        ...
        # self.hrtbeatLbl = ca_biLabelWidget(MAIN_OBJ.device('DNM_MTR_CALIB_HRTBT'),
