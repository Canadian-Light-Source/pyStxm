...
class dev_config_amb(dev_config_base):
    ...
    def init_devices(self):
        ...
        # self.devices['POSITIONERS'][DNM_SAMPLE_FINE_X] = Motor_Qt('IOC:m1',pos_set=POS_TYPE_ES)
        ...
        self.devices["POSITIONERS"][DNM_ZONEPLATE_Z_BASE] = MotorQt("IOC:m10")

        # self.devices['POSITIONERS'][DNM_SAMPLE_X] = Motor_Qt( 'IOC:m11',pos_set=POS_TYPE_ES)
        # self.devices['POSITIONERS'][DNM_SAMPLE_Y] = Motor_Qt('IOC:m12',pos_set=POS_TYPE_ES)
...
class dev_config_uhv(dev_config_base):
    ...
    def init_devices(self):
        ...
        # self.timer.start(100)
        # maps names to device objects
        # self.devices['POSITIONERS'][DNM_SAMPLE_FINE_X] = Motor_Qt('IOC:m100',pos_set=POS_TYPE_ES)
        # self.devices['POSITIONERS'][DNM_SAMPLE_FINE_Y] = Motor_Qt('IOC:m101',pos_set=POS_TYPE_ES)

        prfx = self.sscan_rec_prfx
        self.msg_splash("connecting to: [%s]" % DNM_SAMPLE_FINE_X)
        self.devices["POSITIONERS"][DNM_SAMPLE_FINE_X] = e712_sample_motor(
            "IOC:m100", name="IOC:m100", pos_set=POS_TYPE_ES
        )
        # self.devices['POSITIONERS'][DNM_FINE_X] = Motor_Qt('IOC:m100', name='IOC:m100')
        self.msg_splash("connecting to: [%s]" % DNM_SAMPLE_FINE_Y)
        self.devices["POSITIONERS"][DNM_SAMPLE_FINE_Y] = e712_sample_motor(
            "IOC:m101", name="IOC:m101", pos_set=POS_TYPE_ES
        )
        # self.devices['POSITIONERS'][DNM_FINE_Y] = Motor_Qt('IOC:m101', name='IOC:m101')
        self.msg_splash("connecting to: [%s]" % DNM_COARSE_X)
        self.devices["POSITIONERS"][DNM_COARSE_X] = MotorQt(
            "IOC:m112", name="IOC:m112", pos_set=POS_TYPE_ES
        )
        self.msg_splash("connecting to: [%s]" % DNM_COARSE_Y)
        self.devices["POSITIONERS"][DNM_COARSE_Y] = MotorQt(
            "IOC:m113", name="IOC:m113", pos_set=POS_TYPE_ES
        )
        self.msg_splash("connecting to: [%s]" % DNM_OSA_X)
        self.devices["POSITIONERS"][DNM_OSA_X] = MotorQt(
            "IOC:m104", name="IOC:m104", pos_set=POS_TYPE_ES
        )
        self.msg_splash("connecting to: [%s]" % DNM_OSA_Y)
        self.devices["POSITIONERS"][DNM_OSA_Y] = MotorQt(
            "IOC:m105", name="IOC:m105", pos_set=POS_TYPE_ES
        )
        self.msg_splash("connecting to: [%s]" % DNM_OSA_Z)
        self.devices["POSITIONERS"][DNM_OSA_Z] = MotorQt(
            "IOC:m106C", name="IOC:m106C", pos_set=POS_TYPE_ES, collision_support=True
        )
...
def connect_devices(dev_dct, prfx="uhv", devcfg=None):
    ...
    dev_dct["PVS"][DNM_ZONEPLATE_Z_ADJUST] = BaseDevice(
    ...
    dev_dct["PVS"][DNM_ZONEPLATE_SCAN_MODE] = Bo(
        "BL1610-I10:ENERGY:%s:zp:scanselflag" % prfx, val_only=False, val_kw="value"
    )  # used to control which value gets sent to Zpz, fl or fl - A0
    dev_dct["PVS"][DNM_ZONEPLATE_INOUT] = Bo(
        "BL1610-I10:%s:zp_inout" % prfx, val_only=False, val_kw="value"
    ...
    dev_dct["PVS"][DNM_A0MAXIMUM] = BaseDevice("BL1610-I10:ENERGY:%s:A0Max" % prfx)
    ...
    dev_dct["PVS"][DNM_ENERGY_ENABLE] = Bo(
        "BL1610-I10:ENERGY:%s:enabled" % prfx, val_only=False, val_kw="value"
    )
    ...
    dev_dct["PVS_DONT_RECORD"]["FX_force_done"] = BaseDevice("IOC:m100:ForceDone")
    dev_dct["PVS_DONT_RECORD"]["FY_force_done"] = BaseDevice("IOC:m101:ForceDone")
    ...
    dev_dct["PVS_DONT_RECORD"][DNM_OSAX_TRACKING] = Bo(
        "BL1610-I10:ENERGY:%s:osax_track_enabled" % prfx, val_only=False, val_kw="value"
    )
    dev_dct["PVS_DONT_RECORD"][DNM_OSAY_TRACKING] = Bo(
        "BL1610-I10:ENERGY:%s:osay_track_enabled" % prfx, val_only=False, val_kw="value"
    )
    dev_dct["PVS_DONT_RECORD"][DNM_OSAZ_TRACKING] = Bo(
        "BL1610-I10:ENERGY:%s:osaz_track_enabled" % prfx, val_only=False, val_kw="value"
    )
    ...
    dev_dct["PVS_DONT_RECORD"]["%sstxm:cmd_file" % prfx] = BaseDevice(
        "%sstxm:cmd_file" % prfx
    )
    ...
    dev_dct["PVS_DONT_RECORD"]["%sstxm:scan1:sts" % prfx] = BaseDevice(
        "%sstxm:scan1.SMSG" % prfx
    )
...
def connect_ES_devices(dev_dct, prfx="uhv"):
    if prfx.find("uhv") > -1:
        dev_dct["TEMPERATURES"][POS_TYPE_ES]["CCTL1610-I10:temp:fbk"] = BaseDevice(
            "CCTL1610-I10:temp:fbk", desc="Gatan rod temp"
        )
        pass
    else:
        pass
