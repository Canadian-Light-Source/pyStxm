...
if __name__ == "__main__":
    ...
    for i in range(5):
        idx_str = "idx%d" % i
        idx_dct[idx_str] = {}
        idx_dct[idx_str]["positioners"] = {
            "ENERGY": {
                "value": 123.456,
                "rrbv": 123456,
                "desc": "the energy positioner",
            },
            "EPUOffset": {
                "value": 3.4,
                "rrbv": 34,
                "desc": "the EPU offset for the gap",
            },
        }
        idx_dct[idx_str]["temperatures"] = {
            "TM123": {"value": 56.78, "desc": "gatan rod temp"},
            "TM993": {"value": 42, "rrbv": 42, "desc": "tank temp"},
        }
        idx_dct[idx_str]["time"] = datetime.datetime.now().strftime(
            "%I:%M%p on %B %d, %Y"
        )
        time.sleep(1.0)
