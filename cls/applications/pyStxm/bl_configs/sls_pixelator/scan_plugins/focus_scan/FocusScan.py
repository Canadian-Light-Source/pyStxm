...
from cls.applications.pyStxm.bl_configs.base_scan_plugins.focus_scan.FocusScan import (
    BaseFocusScanClass,
)
...
class FocusScanClass(BaseFocusScanClass):
    """a scan for executing a Focus scan
    ...
    def go_to_scan_start(self) -> bool:
        """
        override base level by just skipping it
        """
        return True
