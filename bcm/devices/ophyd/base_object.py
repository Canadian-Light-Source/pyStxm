...
if __name__ == "__main__":
    ...
    obj = BaseObject(
        "IOC:m912.RBV", write_pv="IOC:m913.VAL", val_only=True, val_kw="value"
    )
    e = obj.add_device(
        "IOC:m913.RBV", write_pv="IOC:m913.VAL", val_only=True, val_kw="value"
    )
    d = obj.add_device(
        "IOC:m914.RBV", write_pv="IOC:m914.VAL", val_only=True, val_kw="timestamp"
    )
    s = obj.add_device("SYSTEM:mode:fbk", val_only=True, val_kw="value")
    t = obj.add_device("BL1610-I10:ENERGY:uhv:enabled", val_only=True, val_kw="value")
