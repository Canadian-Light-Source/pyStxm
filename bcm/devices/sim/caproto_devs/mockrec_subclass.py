...
class CustomMotorFields(MotorFields):
    ...
    calib_done = pvproperty(
        name=":calibDone", dtype=ChannelType.INT, doc="calibration done", read_only=True
    )
...
if __name__ == "__main__":
    ioc_options, run_options = ioc_arg_parser(
        default_prefix="mock:", desc="Run an IOC that mocks a custom motor record"
    )
