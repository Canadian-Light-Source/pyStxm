...
class BeamSpotFeedbackObj(QObject):
    ...
    def __init__(self, main_obj):
        ...
        if fine_sample_positioning_mode is sample_fine_positioning_modes.ZONEPLATE:
            ...
            self.fx = self.main_obj.get_sample_fine_positioner("X")
            self.fy = self.main_obj.get_sample_fine_positioner("Y")
...
class BeamSpotFeedbackObjStandAlone(QObject):
    ...
    def __init__(
        self,
        sample_positioning_mode=sample_positioning_modes.COARSE,
        fine_sample_positioning_mode=sample_fine_positioning_modes.SAMPLEFINE,
    ):
        QObject.__init__(self)
        self.fbkTimer = QTimer()
        self.fbkTimer.timeout.connect(self.on_fbk_timer)
