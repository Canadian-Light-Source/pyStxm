...
from cls.applications.pyStxm.bl_configs.base_scan_plugins.det_scan.DetectorScan import (
    BaseDetectorScanClass,
)

_logger = get_module_logger(__name__)


class DetectorScanClass(BaseDetectorScanClass):
    """a scan for executing a Detector scan
