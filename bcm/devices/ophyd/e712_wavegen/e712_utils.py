...
if __name__ == "__main__":
    ...
    # print ss
    ss = gen_set_wav_gen_start_stop_mode_cmnd(
        3, E712_WVGEN_START_MODES.IMEDDIATELY + E712_WVGEN_FLAGS.USE, _new=True
    )
    ss += gen_set_wav_gen_start_stop_mode_cmnd(
        4,
        E712_WVGEN_START_MODES.IMEDDIATELY
        + E712_WVGEN_FLAGS.USE
        + E712_WVGEN_FLAGS.START_AT_ENDPOS,
        _new=False,
    )
    print(ss)
