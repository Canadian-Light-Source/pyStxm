...
class AppConfigWidget(QtWidgets.QWidget):
    ...
    def update_app_config(self):
        ...
        print(
            "updating app config for section[%s] and attribute[%s] = %s"
            % (section, attr, sender.cur_val)
        )


if __name__ == "__main__":
    app = QtWidgets.QApplication(sys.argv)
    appwidg = AppConfigWidget(
        r"C:\controls\git_sandbox\pyStxm\cls\applications\pyStxm\app"
    )
    appwidg.show()
    app.exec_()
