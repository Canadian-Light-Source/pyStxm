...
from cls.scan_engine.bluesky.tests.image_patterngen import *
...
def pattergen_scan(mtrs, per_pnt_adjustment, final_data, md={"scan_type": "pattern_gen_scan"}
):
    ...
    def do_scan():
        ...
        for dct in final_data:
            ...
            for x_pos, dwell_time in comb_data:
                ...
                print(f"mtr_x.settle_time={mtr_x.settle_time}")
        ...
        print("PatternGenScanClass: pattergen_scan Leaving")
...
class EngineWidget(QWidget):
    ...
    def on_exec_result(self, uids):
        ...
        pprint.pprint(list(primary_docs))
...
class Window(QWidget):
    ...
    def create_point_spec_scan_plan(self):
        ...
        fprefix = fname[:idx1]
        fpath = dir + "\\" + fname
        final_data, total_time, xdata, ydata = process_image(fpath)
        ...
        return(pattergen_scan(mtrs, per_pnt_adjustment=0.0, final_data=final_data))
