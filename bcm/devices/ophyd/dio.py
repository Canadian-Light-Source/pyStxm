...
class digitalIO(BaseObject):
    ...
    def __init__(self, base_signal_name=None, **kwargs):
        super(digitalIO, self).__init__(base_signal_name=base_signal_name, **kwargs)
    ...
    def report(self):
        print("name = %s, type = digitalIO" % self.name)
...
class BaseTrigger(digitalIO):
    ...
    def __init__(self, signal_name, **kwargs):
        super(digitalIO, self).__init__(signal_name, write_pv=signal_name)
