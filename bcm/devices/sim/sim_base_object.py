...
class BaseSimObject(QtCore.QObject):
    ...
    def __init__(
        ...
        super(BaseSimObject, self).__init__()
    ...
    def add_device(
        ...
        if is_dev_attr:
            ...
            self.devs[sig_name] = BaseSimDevice(
                complete_sig_name,
                write_pv=complete_sig_name,
                val_only=val_only,
                val_kw=val_kw,
...
if __name__ == "__main__":
    ...
    obj = BaseSimObject(
        "Fake1PV.RBV", write_pv="Fake1PV.VAL", val_only=False, val_kw="value"
    )
    e = obj.add_device(
        "Fake2PV.RBV", write_pv="Fake2PV.VAL", val_only=False, val_kw="value"
    )
    d = obj.add_device(
        "Fake3PV.RBV", write_pv="Fake3PV.VAL", val_only=False, val_kw="timestamp"
    )
    s = obj.add_device("FAKESYSTEM:mode:fbk", val_only=False, val_kw="value")
    t = obj.add_device("FAKEBL1610-I10:ENERGY:uhv:enabled", val_only=False, val_kw="value")
