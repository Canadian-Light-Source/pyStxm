...
cmd_func_map_dct['modified positioner definition'] = PIXELATOR_modified_positioner_definition
cmd_func_map_dct['modified zonePlate definition'] = PIXELATOR_modified_zonePlate_definition
...
cmd_func_map_dct['ZonePlate IN'] = PIXELATOR_ZonePlate_IN
cmd_func_map_dct['ZonePlate OUT'] = PIXELATOR_ZonePlate_OUT
cmd_func_map_dct['Sample OUT'] = PIXELATOR_Sample_OUT
cmd_func_map_dct['topupMode'] = PIXELATOR_topupMode
cmd_func_map_dct['beamShutterMode'] = PIXELATOR_beamShutterMode
cmd_func_map_dct['loadFile directory'] = PIXELATOR_loadFile_directory
cmd_func_map_dct['loadFile file'] = PIXELATOR_loadFile_file
cmd_func_map_dct['loadDefinition'] = PIXELATOR_loadDefinition
cmd_func_map_dct['change user'] = PIXELATOR_change_user
cmd_func_map_dct['script info'] = PIXELATOR_script_info
