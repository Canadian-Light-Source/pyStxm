...
dev_dct["POSITIONERS"] = [
    ...
    },
    {
        ...
        "desc": "M3_Pitch",
        "class": "Motor_Qt",
        #"dcs_nm": "SIM_VBL1610-I12:m3STXMPitch",
    ...
    },
    {
        ...
        "desc": "Epu_Offset",
        "class": "Motor_Qt",
        #"dcs_nm": "SIM_VBL1610-I12:epuOffset",
    ...
    },
    {
        ...
        "desc": "Epu_Harmonic",
        "class": "Motor_Qt",
        #"dcs_nm": "SIM_VBL1610-I12:epuHarmonic",
    ...
    },
    {
        ...
        "desc": "Polarization",
        "class": "Motor_Qt",
        #"dcs_nm": "SIM_VBL1610-I12:epuPolarization",
    ...
    },
    {
        ...
        "desc": "Epu_Angle",
        "class": "Motor_Qt",
        #"dcs_nm": "SIM_VBL1610-I12:epuAngle",
...
dev_dct["DIO"] = [
    # {'name': 'DNM_GATE', 'class': 'BaseOphydGate', 'dcs_nm': 'CSTXM1610:Co:gate', 'con_chk_nm': ':Run'},
    # {'name': 'DNM_SHUTTER', 'class': 'PvShutter', 'dcs_nm': 'CSTXM1610:Dio:shutter:ctl'},
    # {'name': 'DNM_SHUTTERTASKRUN',  'class': 'make_basedevice', 'dcs_nm': 'CSTXM1610:Dio:shutter:Run'},
    # {'name': 'DNM_POINT_GATE',  'class': 'GateDevice', 'dcs_nm': 'CSTXM1610:Co:gate', 'con_chk_nm': ':Run'},
    # {
    #     "name": "DNM_GATE",
    #     "class": "BaseOphydGate",
    #     "dcs_nm": "CSTXM1610:Co:gate",
    #     "con_chk_nm": ":Run",
    #     "cfg_dct": {"trig_src_pfi": 3, "src_clock_pfi": 15, "ctr_src_pfi": 15},
    # },
    {"name": "DNM_SHUTTER", "class": "PvShutter", "dcs_nm": "CSTXM1610:Dio:shutter:ctl"},
    {
        "name": "DNM_SHUTTERTASKRUN",
        "class": "make_basedevice",
        "dcs_nm": "CSTXM1610:Dio:shutter:Run",
    },
    # {
    #     "name": "DNM_POINT_GATE",
    #     "class": "GateDevice",
...
dev_dct["PVS"] = [
    ...
    },
    {
        ...
        "class": "make_basedevice",
        "cat": "PVS",
        "dcs_nm": "CSTXM1610:bl_api:zp:fbk:tr.I",
    },
    {
    ...
    },
    {
        ...
        "class": "Bo",
        "cat": "PVS",
        "dcs_nm": "PZAC1610-3-I12-27:AutoZero",
    },
    {
        "name": "DNM_SFY_AUTOZERO",
        "class": "Bo",
        "cat": "PVS",
        "dcs_nm": "PZAC1610-3-I12-28:AutoZero",
    },
    {
        "name": "DNM_ZPZ_ADJUST",
        "class": "make_basedevice",
        "cat": "PVS",
        "dcs_nm": "CSTXM1610:bl_api:zp:adjust_zpz",
    },
    {
        "name": "DNM_ZONEPLATE_SCAN_MODE",
        "class": "Mbbo",
        "dcs_nm": "CSTXM1610:bl_api:zp:scanselflag",
    },
    # used to control which value gets sent to Zpz, fl or fl - A0
    # {'name': 'DNM_ZONEPLATE_INOUT', 'class': 'Bo', 'dcs_nm': 'BL1610-I12:zp_inout'},
    # {'name': 'DNM_ZONEPLATE_INOUT_FBK', 'class': 'Mbbi', 'dcs_nm': 'CSTXM1610:bl_api:zp_inout:fbk'},
    # used to convieniently move zp z in and out
    {
        "name": "DNM_DELTA_A0",
        "class": "make_basedevice",
        "cat": "PVS",
        "dcs_nm": "CSTXM1610:bl_api:delta_A0",
    },
    {
        "name": "DNM_IDEAL_A0",
        "class": "make_basedevice",
        "cat": "PVS",
        "dcs_nm": "CSTXM1610:bl_api:zp:fbk:tr.K",
    },
    {
        "name": "DNM_CALCD_ZPZ",
        "class": "make_basedevice",
    ...
    # {'name': 'DNM_A0_FOR_CALC', 'class': 'make_basedevice', 'cat': 'PVS', 'dcs_nm': 'CSTXM1610:bl_api:A0:for_calc'},
    {
        "name": "DNM_ZPZ_POS",
        "class": "make_basedevice",
        "cat": "PVS",
        "dcs_nm": "CSTXM1610:bl_api:zp:zpz_pos",
    },
    {"name": "DNM_ENERGY_ENABLE", "class": "Bo", "dcs_nm": "CSTXM1610:bl_api:enabled"},
    {
        "name": "DNM_ENERGY_RBV",
        "class": "make_basedevice",
        "cat": "PVS",
    ...
    },
    {
        ...
        "class": "make_basedevice",
        "cat": "PVS",
        "dcs_nm": "CSTXM1610:bl_api:zp:def.A",
    },
    {
        "name": "DNM_ZP_DEF",
        "class": "Transform",
        "cat": "PVS",
        "dcs_nm": "CSTXM1610:bl_api:zp:def",
    },
    {
        "name": "DNM_OSA_DEF",
        "class": "Transform",
        "cat": "PVS",
        "dcs_nm": "CSTXM1610:bl_api:osa:def",
    },
    {
    ...
    },
    {
        ...
        "class": "make_basedevice",
        "cat": "PVS",
        "dcs_nm": "CSTXM1610:bl_api:zp:defocus",
        "units": "um",
    },
    {
    ...
    },
    {
        ...
        "class": "make_basedevice",
        "cat": "PVS",
        "dcs_nm": "PZAC1610-3-I12-27:OutputVolt_RBV",
        "rd_only": True,
    },
    {
        ...
        "class": "make_basedevice",
        "cat": "PVS",
        "dcs_nm": "PZAC1610-3-I12-28:OutputVolt_RBV",
        "rd_only": True,
    },
    {
...
dev_dct["E712"] = [
    ...
    },
    {
        ...
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        "dcs_nm": "CSTXM1610:E712:xreset:posns",
        "units": "um",
    },
    {
        ...
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        "dcs_nm": "CSTXM1610:E712:yreset:posns",
        "units": "um",
    },
    {
        ...
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        "dcs_nm": "CSTXM1610:E712:sp_roi:ids",
    },
    {
        "name": "DNM_E712_CURRENT_SP_ID",
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        "dcs_nm": "CSTXM1610:E712:sp_roi:current",
    },
    {
        "name": "DNM_E712_X_START_POS",
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        "dcs_nm": "CSTXM1610:E712:XStartPos",
    },
    {
        "name": "DNM_E712_Y_START_POS",
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        "dcs_nm": "CSTXM1610:E712:YStartPos",
    },
    {
        "name": "DNM_E712_DDL_TBL_0",
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        "dcs_nm": "CSTXM1610:E712:ddl:0",
    },
    {
        "name": "DNM_E712_DDL_TBL_1",
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        "dcs_nm": "CSTXM1610:E712:ddl:1",
    },
    {
        "name": "DNM_E712_DDL_TBL_2",
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        "dcs_nm": "CSTXM1610:E712:ddl:2",
    },
    {
        "name": "DNM_E712_DDL_TBL_3",
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        "dcs_nm": "CSTXM1610:E712:ddl:3",
    },
    {
        "name": "DNM_E712_DDL_TBL_4",
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        "dcs_nm": "CSTXM1610:E712:ddl:4",
    },
    {
        "name": "DNM_E712_DDL_TBL_5",
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        "dcs_nm": "CSTXM1610:E712:ddl:5",
    },
    {
        "name": "DNM_E712_DDL_TBL_6",
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        "dcs_nm": "CSTXM1610:E712:ddl:6",
    },
    {
        "name": "DNM_E712_DDL_TBL_7",
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        "dcs_nm": "CSTXM1610:E712:ddl:7",
    },
    {
        "name": "DNM_E712_DDL_TBL_8",
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        "dcs_nm": "CSTXM1610:E712:ddl:8",
    },
    {
        "name": "DNM_E712_DDL_TBL_9",
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        "dcs_nm": "CSTXM1610:E712:ddl:9",
    },
    # the following are require args wvgen_x, wvgen_y which for astxm are 1,2 (sfx, sfy) and 3,4 for (zpx, zpy)
    {
        ...
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        "dcs_nm": "CSTXM1610:E712:image_idx",
    },
    {
        "name": "DNM_E712_SCAN_MODE",
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        "dcs_nm": "CSTXM1610:E712:ScanMode",
    },
    {
        "name": "DNM_E712_X_START_MODE",
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        #"dcs_nm": "CSTXM1610:E712:wg1:startmode",
        "dcs_nm": "CSTXM1610:E712:WavTbl1StartMode",
    },
    {
        "name": "DNM_E712_Y_START_MODE",
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        #"dcs_nm": "CSTXM1610:E712:wg2:startmode",
        "dcs_nm": "CSTXM1610:E712:WavTbl2StartMode",
    },
    {
        "name": "DNM_E712_X_WAVTBL_IDS",
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        "dcs_nm": "CSTXM1610:E712:wg1_tbl:ids",
    },
    {
        "name": "DNM_E712_Y_WAVTBL_IDS",
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        "dcs_nm": "CSTXM1610:E712:wg2_tbl:ids",
    },
    # short PV's
    {
        ...
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        "dcs_nm": "CSTXM1610:E712:wg1:npts",
    },
    {
        "name": "DNM_E712_Y_NPTS",
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        "dcs_nm": "CSTXM1610:E712:wg2:npts",
    },
    # pvs that hold the flags for each waveformgenerator (4'}, for each supported sp_roi (max of 10'},
    {
        ...
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        #"dcs_nm": "CSTXM1610:E712:wg1:useddl",
        "dcs_nm": "CSTXM1610:E712:WavTbl1UseDDL",
    },
    {
        "name": "DNM_E712_Y_USEDDL",
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        #"dcs_nm": "CSTXM1610:E712:wg2:useddl",
        "dcs_nm": "CSTXM1610:E712:WavTbl2UseDDL",
    },
    {
        "name": "DNM_E712_X_USEREINIT",
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        #"dcs_nm": "CSTXM1610:E712:wg1:usereinit",
        "dcs_nm": "CSTXM1610:E712:WavTbl1UseReinitDDL",
    },
    {
        "name": "DNM_E712_Y_USEREINIT",
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        #"dcs_nm": "CSTXM1610:E712:wg2:usereinit",
        "dcs_nm": "CSTXM1610:E712:WavTbl2UseReinitDDL",
    },
    {
        "name": "DNM_E712_X_STRT_AT_END",
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        #"dcs_nm": "CSTXM1610:E712:wg1:strtatend",
        "dcs_nm": "CSTXM1610:E712:WavTbl1StartAtEndPos",
    },
    {
        "name": "DNM_E712_Y_STRT_AT_END",
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        #"dcs_nm": "CSTXM1610:E712:wg2:strtatend",
        "dcs_nm": "CSTXM1610:E712:WavTbl2StartAtEndPos",
    },
    {
        "name": "DNM_E712_X_USE_TBL_NUM",
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        "dcs_nm": "CSTXM1610:E712:WavGen1UseTblNum",
    },
    {
        "name": "DNM_E712_Y_USE_TBL_NUM",
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        "dcs_nm": "CSTXM1610:E712:WavGen2UseTblNum",
    },
    {
        "name": "DNM_E712_SSPND_CTRLR_FBK",
        "class": "make_basedevice",
        "cat": "PVS_DONT_RECORD",
        "dcs_nm": "CSTXM1610:E712:SuspendCtrlrFbk",
    },
