...
class sample_abstract_motor(MotorQt):
    """
    ...
    def __init__(self, signal_name, **kwargs):
        ...
        MotorQt.__init__(self, signal_name, **kwargs)
        #super().__init__()
    ...
    def do_autozero(self):
        ...
        """
        _logger.info(f"starting autoZero for {self._fine_mtr.name}")

        self._fine_mtr.auto_zero.put(1)
        ...
        while movn != 0:
            ...
            movn = self._fine_mtr.motor_is_moving.get()
            i += 1
        _logger.info(f"Done autoZero for {self._fine_mtr.name}")
...
class e712_sample_motor(MotorQt):
    """
    Represents an motor that is typically a piezo motor, either a sample fine stage or a zoneplate X/Y stage
    """
...
if __name__ == "__main__":
    ...
    coarseX = MotorQt("SMTR1610-3-I12-45", name="COARSE_X")
    ...
    coarseY = MotorQt("SMTR1610-3-I12-46", name="COARSE_Y")
