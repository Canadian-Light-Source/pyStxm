...
class fbkClass(QtWidgets.QWidget):
    ...
    def __init__(
        self, dev, lblText, fbk_val=None, parent=None, engineering_notation=False
    ):
        QtWidgets.QWidget.__init__(self, parent)
        uic.loadUi(os.path.join(uiDir, "fbk.ui"), self)
        self.dev = dev
        self.name = dev.get_name()
        self.devNameLbl.setText(lblText)
        # dev.add_callback('setpoint', self._on_new_pv_data)
        self.pvdetail = None
