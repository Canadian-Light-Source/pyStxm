...
class GreatEyesCCD(SingleTrigger, GreatEyesDetector):
    ...
    #                 root=dest)
    # file_plugin = C(GE_HDF5_Plugin, suffix='HDF1:',
    #                 write_path_template='<path to>/test_data')
    file_plugin = C(
        GE_HDF5_Plugin,
        suffix="HDF1:",
        read_path_template="S:\\test_data",
        write_path_template="/nas/test_data",
        root="S:\\",
    )
    cam = C(GreatEyesDetectorCam, "cam1:")
    image = C(ImagePlugin, "image1:")
...
def go():
    ccd = SimGreatEyesCCD("SIM_CCD0000-I10-02:", name="SIM_GE_CCD")
    # ccd = GreatEyesDetector('SIMCCD0000-I10-02:', name='SIM_GE_CCD')
    # ccd.cam.stage()
    # ccd.cam.trigger()
...
if __name__ == "__main__":
    ...
    ccd = GreatEyesCCD("CCD0000-01:", name="GE_CCD")
    print(ccd.summary())
