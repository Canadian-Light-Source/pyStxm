...
class dev_config_amb(dev_config_base):
    ...
    def init_devices(self):
        ...
        self.devices["POSITIONERS"][DNM_ZONEPLATE_Z_BASE] = MotorQt("SIM_IOC:m10")
...
class dev_config_uhv(dev_config_base):
    ...
    def init_devices(self):
        ...
        self.devices["POSITIONERS"][DNM_SAMPLE_FINE_X] = e712_sample_motor(
            "SIM_IOC:m100", name="SIM_IOC:m100", pos_set=POS_TYPE_ES
        )
        ...
        self.devices["POSITIONERS"][DNM_SAMPLE_FINE_Y] = e712_sample_motor(
            "SIM_IOC:m101", name="SIM_IOC:m101", pos_set=POS_TYPE_ES
        )
        # self.devices['POSITIONERS'][DNM_FINE_Y] = Motor_Qt('SIM_IOC:m101', name='SIM_IOC:m101')
        self.msg_splash("connecting to: [%s]" % DNM_COARSE_X)
        self.devices["POSITIONERS"][DNM_COARSE_X] = MotorQt(
            "SIM_IOC:m112", name="SIM_IOC:m112", pos_set=POS_TYPE_ES
        )
        self.msg_splash("connecting to: [%s]" % DNM_COARSE_Y)
        self.devices["POSITIONERS"][DNM_COARSE_Y] = MotorQt(
            "SIM_IOC:m113", name="SIM_IOC:m113", pos_set=POS_TYPE_ES
        )
        self.msg_splash("connecting to: [%s]" % DNM_OSA_X)
        self.devices["POSITIONERS"][DNM_OSA_X] = MotorQt(
            "SIM_IOC:m104", name="SIM_IOC:m104", pos_set=POS_TYPE_ES
        )
        self.msg_splash("connecting to: [%s]" % DNM_OSA_Y)
        self.devices["POSITIONERS"][DNM_OSA_Y] = MotorQt(
            "SIM_IOC:m105", name="SIM_IOC:m105", pos_set=POS_TYPE_ES
        )
        ...
        self.devices["POSITIONERS"][DNM_DETECTOR_X] = MotorQt(
            "SIM_IOC:m114", name="SIM_IOC:m114", pos_set=POS_TYPE_ES
        )
        self.msg_splash("connecting to: [%s]" % DNM_DETECTOR_Y)
        self.devices["POSITIONERS"][DNM_DETECTOR_Y] = MotorQt(
            "SIM_IOC:m115", name="SIM_IOC:m115", pos_set=POS_TYPE_ES
        )
        self.msg_splash("connecting to: [%s]" % DNM_DETECTOR_Z)
        self.devices["POSITIONERS"][DNM_DETECTOR_Z] = MotorQt(
            "SIM_IOC:m116", name="SIM_IOC:m116", pos_set=POS_TYPE_ES
        )
        self.msg_splash("connecting to: [%s]" % DNM_ZONEPLATE_X)
        self.devices["POSITIONERS"][DNM_ZONEPLATE_X] = e712_sample_motor(
            "SIM_IOC:m102", name="SIM_IOC:m102", pos_set=POS_TYPE_ES
        )
        ...
        self.devices["POSITIONERS"][DNM_ZONEPLATE_Y] = e712_sample_motor(
            "SIM_IOC:m103", name="SIM_IOC:m103", pos_set=POS_TYPE_ES
        )
        ...
        self.devices["POSITIONERS"][DNM_ZONEPLATE_Z_BASE] = MotorQt(
            "SIM_IOC:m111", name="SIM_IOC:m111"
        )
...
def connect_devices(dev_dct, prfx="uhv", devcfg=None):
    ...
    dev_dct["DIO"][DNM_SHUTTER] = DCSShutter("SIM_%sDIO:shutter:ctl" % prfx)
    ...
    dev_dct["DETECTORS"][DNM_LINE_DET] = LineDetectorDevice(
        "SIM_uhvCI:counter:", name=DNM_DEFAULT_COUNTER
    )
    ...
    dev_dct["PVS"][DNM_IDEAL_A0] = BaseDevice(
        "SIM_BL1610-I10:ENERGY:%s:zp:fbk:tr.K" % prfx
    )
    # dev_dct['PVS'][DNM_CALCD_ZPZ] = BaseDevice('SIM_BL1610-I10:ENERGY:%s:zp:fbk:tr.L' % prfx)
    dev_dct["PVS"][DNM_CALCD_ZPZ] = BaseDevice(
        "SIM_BL1610-I10:ENERGY:%s:zp:fbk:tr.I" % prfx
    )

    dev_dct["PVS"]["Zpz_adjust"] = BaseDevice(
        "SIM_BL1610-I10:ENERGY:%s:zp:adjust_zpz" % prfx
    )
    ...
    dev_dct["PVS"][DNM_ZPZ_POS] = BaseDevice(
        "SIM_BL1610-I10:ENERGY:%s:zp:zpz_pos" % prfx
    )
    ...
    dev_dct["PVS"][DNM_ENERGY_ENABLE] = BaseDevice(
        "SIM_BL1610-I10:ENERGY:%s:enabled" % prfx
    )
    ...
    dev_dct["PVS"][DNM_ZP_DEF_A] = BaseDevice(
        "SIM_BL1610-I10:ENERGY:%s:zp:def.A" % prfx
    )

    devcfg.msg_splash("connecting to: [%s]" % "Zp_def1 -> 7")
    dev_dct["PVS"][DNM_ZP_DEF1_A] = BaseDevice(
        "SIM_BL1610-I10:ENERGY:%s:zp1:def.A" % prfx
    )
    dev_dct["PVS"][DNM_ZP_DEF2_A] = BaseDevice(
        "SIM_BL1610-I10:ENERGY:%s:zp2:def.A" % prfx
    )
    dev_dct["PVS"][DNM_ZP_DEF3_A] = BaseDevice(
        "SIM_BL1610-I10:ENERGY:%s:zp3:def.A" % prfx
    )
    dev_dct["PVS"][DNM_ZP_DEF4_A] = BaseDevice(
        "SIM_BL1610-I10:ENERGY:%s:zp4:def.A" % prfx
    )
    dev_dct["PVS"][DNM_ZP_DEF5_A] = BaseDevice(
        "SIM_BL1610-I10:ENERGY:%s:zp5:def.A" % prfx
    )
    dev_dct["PVS"]["Zp_def6_A"] = BaseDevice(
        "SIM_BL1610-I10:ENERGY:%s:zp6:def.A" % prfx
    )
    dev_dct["PVS"]["Zp_def7_A"] = BaseDevice(
        "SIM_BL1610-I10:ENERGY:%s:zp7:def.A" % prfx
    )
    ...
    dev_dct["PVS"][DNM_MONO_EV_FBK] = BaseDevice(
        "SIM_MONO1610-I10-01:energy:fbk", units="eV"
    )
    ...
    dev_dct["PVS"]["Epu_pol_angle"] = BaseDevice(
        "SIM_UND1410-01:polarAngle", units="udeg"
    )
    ...
    dev_dct["PVS"]["Epu_gap_offset"] = BaseDevice(
        "SIM_UND1410-01:gap:offset", units="mm"
    )
    ...
    dev_dct["PVS"][DNM_BEAM_DEFOCUS] = BaseDevice(
        "SIM_BL1610-I10:ENERGY:%s:zp:defocus" % prfx, units="um"
    )

    dev_dct["PVS_DONT_RECORD"]["ticker"] = BaseDevice(
        "SIM_TRG2400:cycles", egu="counts"
    )

    dev_dct["PVS_DONT_RECORD"]["CX_auto_disable_power"] = BaseDevice(
        "SIM_IOC:m112:XPS_AUTO_DISABLE_MODE"
    )
    dev_dct["PVS_DONT_RECORD"]["CY_auto_disable_power"] = BaseDevice(
        "SIM_IOC:m113:XPS_AUTO_DISABLE_MODE"
    )
    dev_dct["PVS_DONT_RECORD"]["DX_auto_disable_power"] = BaseDevice(
        "SIM_IOC:m114:XPS_AUTO_DISABLE_MODE"
    )
    dev_dct["PVS_DONT_RECORD"]["DY_auto_disable_power"] = BaseDevice(
        "SIM_IOC:m115:XPS_AUTO_DISABLE_MODE"
    )

    dev_dct["PVS_DONT_RECORD"]["accRange"] = BaseDevice(
        "SIM_uhvTestSIG:signal:MaxPoints"
    )
    ...
    dev_dct["PVS_DONT_RECORD"][DNM_OSAX_TRACKING] = BaseDevice(
        "SIM_BL1610-I10:ENERGY:%s:osax_track_enabled" % prfx
    )
    dev_dct["PVS_DONT_RECORD"][DNM_OSAY_TRACKING] = BaseDevice(
        "SIM_BL1610-I10:ENERGY:%s:osay_track_enabled" % prfx
    )
    dev_dct["PVS_DONT_RECORD"][DNM_OSAZ_TRACKING] = BaseDevice(
        "SIM_BL1610-I10:ENERGY:%s:osaz_track_enabled" % prfx
    )
    ...
    dev_dct["PVS_DONT_RECORD"]["Set_XY_lockposition"] = BaseDevice(
        "SIM_BL1610-I10:ENERGY:%s:set_xy:lockposn" % prfx, units="um"
    )
    dev_dct["PVS_DONT_RECORD"]["Set_Z_lockposition"] = BaseDevice(
        "SIM_BL1610-I10:ENERGY:%s:set_z:lock_posn" % prfx, units="um"
    )

    dev_dct["PVS"][DNM_AX1_INTERFER_VOLTS] = BaseDevice(
        "SIM_%sAi:ai:ai0_RBV" % prfx, rd_only=True
    )
    dev_dct["PVS"][DNM_AX2_INTERFER_VOLTS] = BaseDevice(
        "SIM_%sAi:ai:ai1_RBV" % prfx, rd_only=True
    )
    ...
    dev_dct["PRESSURES"][POS_TYPE_ES]["FRG1610-3-I12-01:vac:p"] = BaseDevice(
        "SIM_FRG1610-3-I12-01:vac:p", desc="Chamber pressure", units="torr"
    )
    ...
    dev_dct["PRESSURES"][POS_TYPE_ES]["TCG1610-3-I12-03:vac:p"] = BaseDevice(
        "SIM_TCG1610-3-I12-03:vac:p", desc="Turbo backing pressure", units="torr"
    )
    ...
    dev_dct["PRESSURES"][POS_TYPE_ES]["TCG1610-3-I12-04:vac:p"] = BaseDevice(
        "SIM_TCG1610-3-I12-04:vac:p", desc="Load lock pressure", units="torr"
    )
    ...
    dev_dct["PRESSURES"][POS_TYPE_ES]["TCG1610-3-I12-05:vac:p"] = BaseDevice(
        "SIM_TCG1610-3-I12-05:vac:p", desc="Rough line pressure", units="torr"
    )
...
def connect_e712(dev_dct, prfx="uhv", e712_prfx="SIM_IOCE712"):
    ...
    if (
        ...
        # waveform PV's
        dev_dct["PVS_DONT_RECORD"]["DNM_E712_X_START_MODE"] = BaseDevice(
            "SIM_%s:wg1:startmode" % e712_prfx
        )
        dev_dct["PVS_DONT_RECORD"]["DNM_E712_Y_START_MODE"] = BaseDevice(
            "SIM_%s:wg2:startmode" % e712_prfx
        )

        dev_dct["PVS_DONT_RECORD"]["DNM_E712_X_WAVTBL_IDS"] = BaseDevice(
            "SIM_%s:wg1_tbl:ids" % e712_prfx
        )
        dev_dct["PVS_DONT_RECORD"]["DNM_E712_Y_WAVTBL_IDS"] = BaseDevice(
            "SIM_%s:wg2_tbl:ids" % e712_prfx
        )

        # short PV's
        dev_dct["PVS_DONT_RECORD"]["DNM_E712_X_NPTS"] = BaseDevice(
            "SIM_%s:wg1:npts" % e712_prfx
        )
        dev_dct["PVS_DONT_RECORD"]["DNM_E712_Y_NPTS"] = BaseDevice(
            "SIM_%s:wg2:npts" % e712_prfx
        )

        # pvs that hold the flags for each waveformgenerator (4) for each supported sp_roi (max of 10)
        dev_dct["PVS_DONT_RECORD"]["DNM_E712_X_USEDDL"] = BaseDevice(
            "SIM_%s:wg1:useddl" % e712_prfx
        )
        dev_dct["PVS_DONT_RECORD"]["DNM_E712_Y_USEDDL"] = BaseDevice(
            "SIM_%s:wg2:useddl" % e712_prfx
        )

        dev_dct["PVS_DONT_RECORD"]["DNM_E712_X_USEREINIT"] = BaseDevice(
            "SIM_%s:wg1:usereinit" % e712_prfx
        )
        dev_dct["PVS_DONT_RECORD"]["DNM_E712_Y_USEREINIT"] = BaseDevice(
            "SIM_%s:wg2:usereinit" % e712_prfx
        )

        dev_dct["PVS_DONT_RECORD"]["DNM_E712_X_STRT_AT_END"] = BaseDevice(
            "SIM_%s:wg1:strtatend" % e712_prfx
        )
        dev_dct["PVS_DONT_RECORD"]["DNM_E712_Y_STRT_AT_END"] = BaseDevice(
            "SIM_%s:wg2:strtatend" % e712_prfx
        )

        dev_dct["PVS_DONT_RECORD"]["DNM_E712_X_USE_TBL_NUM"] = BaseDevice(
            "SIM_%s:WavGen1UseTblNum" % e712_prfx
        )
        dev_dct["PVS_DONT_RECORD"]["DNM_E712_Y_USE_TBL_NUM"] = BaseDevice(
            "SIM_%s:WavGen2UseTblNum" % e712_prfx
        )
