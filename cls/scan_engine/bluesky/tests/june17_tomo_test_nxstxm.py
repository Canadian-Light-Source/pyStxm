...
if __name__ == "__main__":
    ...
    uids = [
        "2b5f506e-7826-4616-814f-db4c796b5010",
        "eef81630-80dc-4160-ae95-f098fda73585",
        "9216ecc5-c862-44e1-acef-f2027a45cea4",
        "eb8376f5-34fa-4b31-befe-245e6bb8c03d",
        "8cba7b29-1a25-4c97-90c2-def47943027e",
    ]
    first_uid = uids[0]
    last_uid = uids[-1]
